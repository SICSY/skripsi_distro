...
// import { saveFileToPublic, saveProductImage, deleteFileFromPublic, validateFile } from "@/lib/action/admin/product/file-upload";
...
//     if (newFiles.image) {
//       // Validate file before processing
//       const validation = validateFile(newFiles.image, "image");
//       if (!validation.valid) {
//         return { success: false, message: validation.error };
//       }

//       const newImageUrl = await saveProductImage(newFiles.image);
//       finalImageUrl = newImageUrl;

//       // If there was an original image and a new one is uploaded, delete the original
//       if (originalFiles?.imageUrl) {
//         await deleteFileFromPublic(originalFiles.imageUrl);
//       }
//     } else if (originalFiles?.imageUrl && !formData.imageUrl) {
//       // Image was removed from the form, delete original
//       await deleteFileFromPublic(originalFiles.imageUrl);
//       finalImageUrl = null;
//     }
...
// export async function deleteProductWithFiles(productId: string, imageUrl?: string) {
//   try {
//     // Delete product from database
...
//     // Delete associated image from public folder
//     if (imageUrl) {
//       await deleteFileFromPublic(imageUrl);
//     }
