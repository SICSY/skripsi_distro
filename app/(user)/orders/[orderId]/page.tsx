...
import { ArrowLeft, Package, User, Phone, MapPin, Clock, CheckCircle, AlertCircle, Loader2, Download, Eye, Palette, Truck, PackageCheck, XCircle } from "lucide-react";
...
const statusConfig = {
  ...
  PROCESSING: {
    ...
    color: "bg-blue-500",
    icon: Package,
    description: "Your custom design is being produced"
  },
  COMPLETED: {
    label: "Completed",
    color: "bg-green-500",
...
export default function TrackOrderPage() {
  ...
  useEffect(() => {
    const fetchOrderData = async () => {
      ...
      try {
        setIsLoading(true);
        const response = await fetch(`/api/user/orders/${orderId}`, { method: "GET" });
